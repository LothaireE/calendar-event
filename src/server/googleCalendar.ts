...
export async function createCalendarEvent(
    ...
    if (calendarUser.primaryEmailAddress == null)  throw new Error("Clerk user has no Email.")
    ...
    const calendarEvent = await google.calendar("v3").events.insert({
        ...
        requestBody: {
            attendees: [
                ...
                { email: calendarUser.primaryEmailAddress.emailAddress, displayName: calendarUser.fullName, responseStatus: "accepted" },
            ],
