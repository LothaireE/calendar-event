...
export default function EventForm ({event} : { event?: {
    ...
    async function handleDelete() {
        ...
        startDeleteTransition(async () => {
            ...
            if (result?.error) form.setError("root", {
                type: "manual",
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Textarea {...field} placeholder="Enter event description" className="resize-none h-32"/>
                            </FormControl>
                            <FormDescription>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input type="number" {...field} placeholder="Enter duration in minutes" />
                            </FormControl>
                            <FormDescription>
                    ...
                    {event && (
                        <AlertDialog>
                            <AlertDialogTrigger asChild>
                                <Button variant="destructiveGhost" disabled={form.formState.isSubmitting || form.formState.isValidating || isDeletePending}>    
                                    Delete Event
                                </Button>   
                            </AlertDialogTrigger>
                            <AlertDialogContent>
